...
const PLATFORM_NAME_VISIONOS = 'visionOS';
...
const desiredCapConstraints = /** @type {const} */ ({
  platformName: {
    ...
    presence: true,
    isString: true,
    inclusionCaseInsensitive: [PLATFORM_NAME_IOS, PLATFORM_NAME_TVOS, PLATFORM_NAME_VISIONOS],
  },
  browserName: {
    isString: true,
  },
...
export {desiredCapConstraints, PLATFORM_NAME_IOS, PLATFORM_NAME_TVOS, PLATFORM_NAME_VISIONOS};
